...
class CLMDOrderWidget extends StatefulWidget {
  const CLMDOrderWidget({
    Key key,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _CLMDOrderWidgetState createState() => _CLMDOrderWidgetState();
}

class _CLMDOrderWidgetState extends State<CLMDOrderWidget> {
