...
class PhotographyOrderWidget extends StatefulWidget {
  const PhotographyOrderWidget({
    Key key,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _PhotographyOrderWidgetState createState() => _PhotographyOrderWidgetState();
}

class _PhotographyOrderWidgetState extends State<PhotographyOrderWidget> {
