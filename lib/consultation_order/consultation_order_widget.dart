...
class ConsultationOrderWidget extends StatefulWidget {
  const ConsultationOrderWidget({
    Key key,
    this.jobPostDetails,
  }) : super(key: key);
  ...
  @override
  _ConsultationOrderWidgetState createState() =>
      _ConsultationOrderWidgetState();
}

class _ConsultationOrderWidgetState extends State<ConsultationOrderWidget> {
